#! /usr/bin/env python3
# randomQuizGenerator.py - Creates quizess wtih questions and answers in
...
'Charleston','Wisconsin':'Madison','Wyoming':'Cheynne'}
...
for quizNum in range(35):
    ...
    for questionNum in range(50):
        ...
        answerOptions = wrongAnswers + [correctAnswer] # Can only concatenate a list to a list so [] is needed
        random.shuffle(answerOptions) # shuffle otherwise the answer is always the last one – 'D'
